...
def get_ip_data():
    ...
    input_devtype = input("What is the device type?")
    input_color = input("What is the device color?")
    d = {"IP": input_ip, "driver": input_driver, "DevType": input_devtype, "Color": input_color}
    return d
